% Standalone LuaLaTeX source; all diagrams and chart data are embedded.
% Compile twice: lualatex line_lab_guide.tex
...
\begin{lstlisting}
cd docs
lualatex -interaction=nonstopmode -halt-on-error line_lab_guide.tex
lualatex -interaction=nonstopmode -halt-on-error line_lab_guide.tex
\end{lstlisting}
\end{minipage}\par
